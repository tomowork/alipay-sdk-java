 ...
 *
 * @author auto create
 * @since 1.0, 2017-01-13 17:31:07
 */
public class AlipayEcoCplifeCommunityModifyModel extends AlipayObject {

	private static final long serialVersionUID = 5291545929272262242L;
...
高德POI ID的获取方法可参考：<a href="http://lbs.amap.com/api/webservice/guide/api/search/">高德WEB服务API文档</a>
	 */
...
高德经纬度查询：<a href="http://lbs.amap.com/console/show/picker">人工方式</a>|<a href="http://lbs.amap.com/api/webservice/guide/api/search/">接口方式</a>
坐标系转换：<a href="http://lbs.amap.com/api/webservice/guide/api/convert/">查看接口文档</a>
	 */
